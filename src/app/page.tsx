    ...
    <>
      <style>{`
        ...
        .hp-hero-bg {
          ...
          background:
            radial-gradient(ellipse 70% 60% at 65% -5%, rgba(27,77,62,0.1) 0%, transparent 60%),
            radial-gradient(ellipse 50% 40% at 5%  80%, rgba(13,43,32,0.07) 0%, transparent 50%),
            radial-gradient(ellipse 40% 35% at 95% 55%, rgba(201,168,76,0.05) 0%, transparent 40%);
        }
        ...
        .hp-overline-wrap { display: inline-flex; align-items: center; gap: 10px; padding: 7px 14px 7px 8px; background: rgba(27,77,62,0.08); border: 1px solid rgba(27,77,62,0.18); border-radius: 999px; margin-bottom: 28px; }
        .hp-overline-logo { width: 26px; height: 26px; object-fit: contain; }
        .hp-overline-dot { width: 5px; height: 5px; border-radius: 50%; background: var(--g-bright); box-shadow: 0 0 6px rgba(56,178,122,0.6); animation: breathe 2s ease infinite; }
        ...
        .hp-stats { display: flex; border: 1.5px solid rgba(27,77,62,0.12); border-radius: 16px; overflow: hidden; background: #FFFFFF; box-shadow: var(--shadow-sm); }
        .hp-stat { flex: 1; padding: 18px 20px; border-right: 1px solid rgba(27,77,62,0.08); transition: background 0.2s; }
        ...
        .hp-card {
          background: #FFFFFF; border: 1.5px solid rgba(27,77,62,0.18);
          border-radius: 24px; padding: 26px;
          box-shadow: 0 20px 60px rgba(7,24,18,0.14), 0 4px 16px rgba(7,24,18,0.08);
          position: relative; overflow: hidden;
        }
        .hp-card::before {
          content: ''; position: absolute; top: 0; left: 0; right: 0; height: 3px;
          background: linear-gradient(90deg, var(--g-dark), var(--g-mid), var(--au-mid));
        }
        .hp-card-img {
          background: var(--bg-raised); border: 1px solid rgba(27,77,62,0.1);
          border-radius: 16px; height: 165px;
          display: flex; align-items: center; justify-content: center;
          margin-bottom: 20px; position: relative; overflow: hidden;
        }
        .hp-card-img::after { content: ''; position: absolute; inset: 0; background: linear-gradient(135deg, rgba(27,77,62,0.04), transparent); pointer-events: none; }
        .hp-notif {
          position: absolute; bottom: -16px; right: -16px;
          background: #FFFFFF; border: 1.5px solid rgba(27,77,62,0.15);
          border-radius: 14px; padding: 11px 14px;
          display: flex; align-items: center; gap: 10px;
          box-shadow: var(--shadow-lg); z-index: 10;
        }
        .hp-notif-icon { width: 30px; height: 30px; background: rgba(27,77,62,0.1); border: 1px solid rgba(27,77,62,0.2); border-radius: 8px; display: flex; align-items: center; justify-content: center; }

        /* ── FEATURES ── */
        .hp-features-wrap { padding: 100px 28px; }
        .hp-features-inner { max-width: 1280px; margin: 0 auto; display: grid; grid-template-columns: 1fr 2fr; gap: 80px; align-items: flex-start; }
        ...
        .hp-section-h { font-size: clamp(28px,4vw,44px); font-weight: 900; color: var(--tx-bright); letter-spacing: -0.04em; line-height: 1.08; margin-bottom: 16px; }
        .hp-section-p { font-size: 15px; color: var(--tx-muted); line-height: 1.75; margin-bottom: 28px; }
        ...
        .hp-feat.green:hover { border-color: rgba(27,77,62,0.28); }
        .hp-feat.gold:hover { border-color: rgba(201,168,76,0.32); }
        .hp-feat-icon-green { width: 46px; height: 46px; background: rgba(27,77,62,0.08); border: 1px solid rgba(27,77,62,0.2); border-radius: 13px; display: flex; align-items: center; justify-content: center; margin-bottom: 16px; color: var(--g-rich); }
        .hp-feat-icon-gold  { width: 46px; height: 46px; background: rgba(201,168,76,0.1); border: 1px solid rgba(201,168,76,0.25); border-radius: 13px; display: flex; align-items: center; justify-content: center; margin-bottom: 16px; color: var(--au-dark); }
        ...
        /* ── STEPS ── */
        .hp-steps-wrap { padding: 100px 28px; }
        .hp-steps-inner { max-width: 1280px; margin: 0 auto; }
        .hp-steps-head { text-align: center; margin-bottom: 56px; }
        .hp-steps-grid { display: grid; grid-template-columns: repeat(3, 1fr); background: #FFFFFF; border: 1.5px solid rgba(27,77,62,0.12); border-radius: 24px; overflow: hidden; box-shadow: var(--shadow-md); }
        .hp-step { padding: 44px 36px; border-right: 1px solid rgba(27,77,62,0.08); transition: background 0.2s; }
        .hp-step:last-child { border-right: none; }
        .hp-step:hover { background: rgba(27,77,62,0.03); }
        .hp-step-n { font-size: 68px; font-weight: 900; letter-spacing: -0.06em; line-height: 1; margin-bottom: 14px; color: rgba(27,77,62,0.1); }
        ...
        /* ── TRUST ── */
        .hp-trust-wrap { padding: 100px 28px; }
        .hp-trust-inner { max-width: 1280px; margin: 0 auto; display: grid; grid-template-columns: 1fr 1fr; gap: 80px; align-items: center; }
        .hp-trust-card {
          background: #FFFFFF; border: 1.5px solid rgba(27,77,62,0.15);
        ...
        /* ── QR ── */
        .hp-qr-wrap { padding: 100px 28px; }
        .hp-qr-inner { max-width: 1280px; margin: 0 auto; display: grid; grid-template-columns: 1fr 1fr; gap: 80px; align-items: center; }
        .hp-qr-card {
          background: #FFFFFF; border: 1.5px solid rgba(27,77,62,0.15);
        ...
        /* ── FOOTER ── */
        .hp-footer { border-top: 1px solid rgba(27,77,62,0.12); padding: 32px 28px; }
        ...
        /* ── RESPONSIVE ── */
        @media (max-width: 1024px) { .hp-hero-inner { grid-template-columns: 1fr; gap: 56px; } .hp-trust-inner { grid-template-columns: 1fr; gap: 48px; } .hp-qr-inner { grid-template-columns: 1fr; gap: 48px; } }
        @media (max-width: 900px)  { .hp-features-inner { grid-template-columns: 1fr; } .hp-features-sticky { position: static; } .hp-features-grid { grid-template-columns: 1fr 1fr; } }
        @media (max-width: 768px)  { .hp-steps-grid { grid-template-columns: 1fr; } .hp-step { border-right: none; border-bottom: 1px solid rgba(27,77,62,0.08); } .hp-step:last-child { border-bottom: none; } .hp-hero { padding: 80px 20px; } .hp-features-wrap, .hp-steps-wrap, .hp-trust-wrap, .hp-qr-wrap { padding: 72px 20px; } }
        @media (max-width: 480px)  { .hp-features-grid { grid-template-columns: 1fr; } .hp-stats { flex-direction: column; } .hp-stat { border-right: none; border-bottom: 1px solid rgba(27,77,62,0.08); } }
      `}</style>
      ...
      <div className="hp">
        ...
        <section className="hp-hero">
          ...
          <div className="hp-hero-inner">
            <div className="animate-fade-up">
              <div className="hp-overline-wrap">
                <img src="/gcoc.png" alt="Gordon College" className="hp-overline-logo" />
              ...
              <div className="hp-card-wrap">
                <div className="hp-card">
                  ...
                  <div className="hp-card-img">
                    <div style={{ width: '76px', height: '76px', background: 'rgba(27,77,62,0.08)', border: '1px solid rgba(27,77,62,0.18)', borderRadius: '20px', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1 }}>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', paddingTop: '16px', borderTop: '1px solid rgba(27,77,62,0.08)' }}>
                    <div>
                ...
                <div className="hp-notif">
                  <div className="hp-notif-icon">
                    <CheckCircle2 size={15} color="var(--g-rich)" strokeWidth={2} />
                  </div>
                  <div>
        ...
        {/* ── FEATURES ── */}
        <section className="hp-features-wrap">
          <div className="hp-features-inner">
            <div className="hp-features-sticky">
              <div className="hp-eyebrow">Why Rentora</div>
              <h2 className="hp-section-h">Built for GC.<br /><span style={{ color: 'var(--tx-muted)', fontWeight: '400' }}>By a GC student.</span></h2>
              <p className="hp-section-p">Safety, trust, and simplicity — designed with the Gordon College campus experience in mind.</p>
            ...
            <div className="hp-features-grid">
              {features.map((f, i) => (
                <div key={i} className={`hp-feat ${f.gold ? 'gold' : 'green'}`}>
                  <div className={f.gold ? 'hp-feat-icon-gold' : 'hp-feat-icon-green'}>{f.icon}</div>
                  <h3>{f.title}</h3>
                  <p>{f.desc}</p>
                </div>
              ))}
        ...
        <section className="hp-steps-wrap">
          <div className="hp-steps-inner">
            <div className="hp-steps-head">
              <div className="hp-eyebrow" style={{ justifyContent: 'center' }}>How it works</div>
              <h2 className="hp-section-h" style={{ textAlign: 'center' }}>Up and running<br /><span style={{ color: 'var(--g-mid)' }}>in minutes.</span></h2>
            </div>
            <div className="hp-steps-grid">
              {[
                { n: '01', color: 'var(--g-mid)', glow: 'rgba(27,77,62,0.4)', title: 'Create your account', desc: 'Sign up with your @gordoncollege.edu.ph email. Verification is instant and automatic.' },
                { n: '02', color: 'var(--au-mid)', glow: 'rgba(201,168,76,0.4)', title: 'Browse or list items', desc: 'Find what you need or list your own items to earn from them while they sit unused.' },
                { n: '03', color: 'var(--g-mid)', glow: 'rgba(27,77,62,0.4)', title: 'Rent with confidence', desc: 'Request, agree on dates, and transact safely within the Gordon College community.' },
              ].map((step, i) => (
                <div key={i} className="hp-step">
                  <div className="hp-step-n">{step.n}</div>
                  <div className="hp-step-bar" style={{ background: step.color, boxShadow: `0 0 10px ${step.glow}` }} />
                  <h3>{step.title}</h3>
                  <p>{step.desc}</p>
                </div>
              ))}
        ...
        {/* ── TRUST ── */}
        <section className="hp-trust-wrap">
          <div className="hp-trust-inner">
            <div>
              <div className="hp-eyebrow">Trust & Safety</div>
              <h2 className="hp-section-h">Your reputation<br /><span className="gold-shimmer">is currency.</span></h2>
              <p className="hp-section-p">Every rental you complete builds your Trust Score — a transparent rating visible to the entire GC community.</p>
              {[
            ...
            <div className="hp-trust-card">
              <div style={{ display: 'flex', alignItems: 'center', gap: '14px', marginBottom: '24px', paddingBottom: '22px', borderBottom: '1px solid rgba(27,77,62,0.1)' }}>
                <div style={{ width: '52px', height: '52px', background: 'linear-gradient(135deg, var(--g-deep), var(--g-dark), var(--g-mid))', border: '1.5px solid rgba(92,219,149,0.2)', borderRadius: '15px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#FFFFFF', fontWeight: '900', fontSize: '20px', boxShadow: '0 4px 16px rgba(7,24,18,0.2)' }}>L</div>
                <div>
              ...
              <div style={{ background: 'var(--bg-raised)', borderRadius: '14px', padding: '20px', marginBottom: '16px', border: '1px solid rgba(27,77,62,0.08)' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '10px' }}>
                {[{ l: 'Rentals', v: '12' }, { l: 'Reviews', v: '10' }, { l: 'Items', v: '3' }].map((s, i) => (
                  <div key={i} style={{ textAlign: 'center', padding: '14px 8px', background: 'var(--bg-raised)', borderRadius: '12px', border: '1px solid rgba(27,77,62,0.08)' }}>
        ...
        {/* ── QR CODE ── */}
        <section className="hp-qr-wrap">
          <div className="hp-qr-inner">
            <div>
              <div className="hp-eyebrow">Access Rentora</div>
              <h2 className="hp-section-h">Scan to get<br /><span className="gold-shimmer">started instantly.</span></h2>
              <p className="hp-section-p" style={{ marginBottom: '32px' }}>Open your phone camera and point it at the QR code — no typing needed. Works on any device.</p>
              {[
                { n: '01', text: 'Open your camera or QR scanner app', c: 'var(--g-mid)', bg: 'rgba(27,77,62,0.08)', b: 'rgba(27,77,62,0.2)' },
                { n: '02', text: 'Point it at the QR code on the right', c: 'var(--au-dark)', bg: 'var(--au-glow)', b: 'rgba(201,168,76,0.2)' },
                { n: '03', text: 'Tap the link and you\'re in', c: 'var(--g-mid)', bg: 'rgba(27,77,62,0.08)', b: 'rgba(27,77,62,0.2)' },
              ].map((s, i) => (
                <div key={i} style={{ display: 'flex', alignItems: 'center', gap: '14px', marginBottom: '14px' }}>
                  ...
                  <p style={{ fontSize: '14px', color: 'var(--tx-body)', margin: 0, fontWeight: '500' }}>{s.text}</p>
                </div>
              ))}
              <div style={{ marginTop: '24px', padding: '14px 18px', background: '#FFFFFF', border: '1.5px solid rgba(27,77,62,0.12)', borderRadius: '14px', display: 'flex', alignItems: 'center', gap: '12px', boxShadow: 'var(--shadow-sm)' }}>
                ...
                <p style={{ fontSize: '13px', color: 'var(--tx-muted)', margin: 0 }}>
                  <a href="https://rentora-tau-flame.vercel.app" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--g-mid)', fontWeight: '700', textDecoration: 'none' }}>rentora-tau-flame.vercel.app</a>
                </p>
              </div>
            </div>
            <div style={{ display: 'flex', justifyContent: 'center' }}>
              <div className="hp-qr-card">
                ...
                <div style={{ background: '#FFFFFF', borderRadius: '18px', padding: '16px', display: 'inline-block', boxShadow: 'var(--shadow-lg)', marginBottom: '24px', border: '1.5px solid rgba(27,77,62,0.12)' }}>
                  <img src="https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=https://rentora-tau-flame.vercel.app/&color=0D2B20&bgcolor=ffffff&qzone=1&format=png" alt="Scan QR" width={200} height={200} style={{ display: 'block', borderRadius: '8px' }} />
                </div>
                ...
                <div style={{ display: 'flex', justifyContent: 'center', gap: '6px' }}>
                  {[0,1,2].map(i => (
                    <div key={i} style={{ width: '6px', height: '6px', borderRadius: '50%', background: i === 1 ? 'var(--au-mid)' : 'var(--border-mid)' }} />
                  ))}
                </div>
              </div>
            </div>
        ...
        <div style={{ padding: '0 28px 80px' }}>
          <div className="hp-cta-section" style={{ borderRadius: '28px', padding: '80px 48px', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
            <div style={{ position: 'absolute', top: '-100px', left: '50%', transform: 'translateX(-50%)', width: '500px', height: '400px', background: 'radial-gradient(ellipse, rgba(92,219,149,0.06) 0%, transparent 60%)', pointerEvents: 'none' }} />
            <div style={{ position: 'relative' }}>
              <div style={{ display: 'inline-flex', alignItems: 'center', gap: '10px', marginBottom: '24px', padding: '7px 16px 7px 8px', background: 'rgba(255,255,255,0.08)', border: '1px solid rgba(255,255,255,0.12)', borderRadius: '999px' }}>
                <img src="/gcoc.png" alt="GC" style={{ width: '22px', height: '22px', objectFit: 'contain' }} />
                <span style={{ fontSize: '11px', fontWeight: '800', color: 'rgba(240,253,244,0.7)', letterSpacing: '0.1em', textTransform: 'uppercase' }}>Gordon College Students Only</span>
              </div>
              <h2 style={{ fontSize: 'clamp(30px,5vw,52px)', fontWeight: '900', color: '#F0FDF4', letterSpacing: '-0.05em', marginBottom: '16px', lineHeight: '1.05' }}>
                Your campus marketplace<br /><span className="gold-shimmer">is waiting.</span>
              </h2>
              <p style={{ fontSize: '16px', color: 'rgba(240,253,244,0.6)', marginBottom: '40px', maxWidth: '420px', margin: '0 auto 40px', lineHeight: '1.8' }}>
              ...
              <div style={{ display: 'flex', gap: '12px', justifyContent: 'center', flexWrap: 'wrap' }}>
                {user ? (
                  ...
                  <>
                    ...
                    <Link href="/auth/login" style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', padding: '13px 26px', background: 'rgba(255,255,255,0.08)', border: '1px solid rgba(255,255,255,0.15)', color: 'rgba(240,253,244,0.8)', fontWeight: '600', fontSize: '14px', borderRadius: '12px', textDecoration: 'none', transition: 'all 0.2s' }}>Sign in</Link>
                  </>
                )}
              </div>
            </div>
        ...
        <footer className="hp-footer">
          <div className="hp-footer-inner">
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{ width: '30px', height: '30px', background: 'linear-gradient(135deg, var(--g-deep), var(--g-dark), var(--g-mid))', border: '1px solid rgba(27,77,62,0.2)', borderRadius: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'hidden' }}>
                <img src="/gcoc.png" alt="GC" style={{ width: '22px', height: '22px', objectFit: 'contain' }} />
              </div>
