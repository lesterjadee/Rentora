...
export default function ForgotPasswordPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!email.endsWith('@gordoncollege.edu.ph')) {
      setError('Please use your @gordoncollege.edu.ph email.')
      setLoading(false)
      return
    }
    ...
    <div style={{ minHeight: '100vh', display: 'flex', fontFamily: 'system-ui, sans-serif' }}>
      ...
      <div style={{
        ...
        <div style={{ position: 'relative' }}>
          ...
          <p style={{ fontSize: '15px', color: 'rgba(255,255,255,0.6)', lineHeight: '1.7', marginBottom: '40px' }}>
            No worries! Enter your Gordon College email and we'll send you a reset link instantly.
          </p>
      ...
      <div style={{
        ...
        <div style={{ width: '100%', maxWidth: '400px' }}>
          <div style={{
            width: '56px', height: '56px', backgroundColor: '#eff6ff',
          ...
          {message ? (
            <div style={{
              ...
              border: '1px solid #86efac', borderRadius: '16px', textAlign: 'center'
            }}>
              <p style={{ fontSize: '40px', marginBottom: '12px' }}>📬</p>
              <p style={{ fontWeight: '700', fontSize: '16px', color: '#15803d', marginBottom: '8px' }}>
                Check your email!
              </p>
              ...
              <p style={{ fontSize: '13px', color: '#64748b' }}>
                ...
                <button
                  onClick={() => setMessage('')}
                  style={{ color: '#26619C', fontWeight: '600', background: 'none', border: 'none', cursor: 'pointer', fontSize: '13px' }}
                >try again</button>
              </p>
            </div>
          ) : (
            <form onSubmit={handleSubmit}>
              <div style={{ marginBottom: '20px' }}>
                ...
                <input
                  ...
                  required placeholder="202411738@gordoncollege.edu.ph"
                  style={{
